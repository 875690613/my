...
export default defineConfig({
  publicPath: '/my/dist/', // 例如：'/my-vue-app/', // 替换为你的仓库名称，如果你的项目部署在 GitHub Pages 上，则需要设置此项以正确加载资源。例如：'/your-repo-name/'

  base: '/my/dist/', // 替换为你的仓库名称，如果你的项目部署在 GitHub Pages 上，则需要设置此项以正确加载资源。例如：'/your-repo-name/'
  plugins: [
    vue(),
    ReactivityTransform(),
    AutoImport({
